      ...
      {errorOccured ? (
        ...
        <div className="flex flex-col  gap-6">
          ...
          <div className="flex  items-center gap-4">
            <Link href={'https://www.facebook.com/profile.php?id=61586716936815'} target="_blank"><svg className="w-6 h-auto" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" ><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" /></svg></Link>

            {/* <Link href={'https://facebook.com'} target="_blank"><svg className="w-6 h-auto" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" ><rect width="20" height="20" x="2" y="2" rx="5" ry="5" /><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" /><line x1="17.5" x2="17.51" y1="6.5" y2="6.5" /></svg></Link> */}

            <Link href={'https://x.com/memorylink_app'} target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
            ...
            {/* <Link href={'https://facebook.com'} target="_blank"><svg className="w-6 h-auto" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
          ...
          <div className="flex items-center justify-between gap-2 bg-back-dark dark:bg-back-light py-3 px-6 rounded-full text-txt-dark dark:text-txt-light">
            ...
            <button
              onClick={handleCopy}
              className="p-2 rounded-lg hover:bg-white/10 dark:hover:bg-black/10 transition cursor-pointer"
